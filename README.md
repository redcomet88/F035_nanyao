...
### 2.2 功能模块图
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/734a2fd3c5584d3d851e8bdb40c83e50.jpeg)
## 3 功能展示
### 知识图谱的构建
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/c077e8362eb1450795af160b6d1bd15e.png)
在neo4j中查看知识图谱：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/9ea9e534f5da48089a89e93feb142883.png)
### 3.1 登录 & 注册
登录注册做的是一个可以切换的登录注册界面，点击去登录后者去注册可以切换，背景是一个视频，循环播放。
登录需要验证用户名和密码是否正确，如果**不正确会有错误提示**。
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/30d41db59fe74c52bebfb0a5a425a0ba.png)
注册需要**验证用户名是否存在**，如果错误会有提示。
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/cb511673b507477d850dc5c25e093a47.png)
### 3.2 主页
主页的布局采用了左侧是菜单，右侧是操作面板的布局方法，右侧的上方还有用户的头像和退出按钮，如果是新注册用户，没有头像，这边则不显示，需要在个人设置中上传了头像之后就会显示。
### 3.3 药材搜索 & 药材详情
药材搜索：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/41a019343b1f4eacafc7b16071157dcd.png)
药材查看：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/21f5bf98da0842439ad0083faf46638c.png)
药材详情
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/35a609e7ff88404289fdf8a941902470.png)
### 3.4 知识图谱可视化
知识图谱：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/16c3f2e57566409b93a321281ffe045e.png)
检索知识图谱：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/5a1208b3f3f94354b7d97c5f584ce346.png)
### 3.5  数据大屏可视化
数据大屏可视化包含了
以下的分析，带有地图分析、药材的类型、出处等分析指标：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/e8ebe586f783464186e799e044edb448.png)
### 3.6 个人设置
